...
@section('content')
  ...
  <main class="p-6" style="font-family: var(--font-secondary);">
    <div class="flex items-start justify-between mb-6">
      ...
      <div class="ml-4">
  <a href="{{ route('dashboard.empleados.create') }}" data-role="admin" class="inline-flex items-center px-4 py-2 rounded-md text-white btn-green" data-nav style="background: var(--green);">
