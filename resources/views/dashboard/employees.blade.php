...
@section('content')
  <main class="p-6" style="font-family: var(--font-secondary);">
    <div class="flex items-start justify-between mb-6">
      ...
      <div class="ml-4">
  <button type="button" class="inline-flex items-center px-4 py-2 rounded-md text-white btn-green js-open-form-modal" data-modal-target="#employeeModal" style="background: var(--green);">
...
@component('components.modal-form', ['id' => 'employeeModal', 'title' => 'Agregar Nuevo Empleado'])
  <form method="POST" action="#" class="space-y-4">
    ...
    <div class="mt-4 flex items-center justify-end gap-3">
        ...
        <div class="ml-auto">
          <button type="submit" class="px-5 py-2 rounded-md text-white btn-green">Guardar Empleado</button>
        </div>
    </div>
  </form>
@endcomponent
