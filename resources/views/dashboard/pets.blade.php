...
@section('content')
  ...
  <main class="p-6" style="font-family: var(--font-secondary);">
    <div class="flex items-start justify-between mb-6">
      <div>
        <h1 class="text-3xl font-extrabold mb-1" style="font-family: var(--font-primary); color: var(--text-title);">Mascotas</h1>
        <p class="text-sm text-gray-600">Gestiona la información de las mascotas</p>
      </div>
    ...
    <div>
      @include('components.lists.listPet')
    </div>
  </main>
  @endif
@endsection
