...
@section('content')
  @if(!empty($showCreate))
    @include('components.forms.formClient')
  @else
  <main class="p-6" style="font-family: var(--font-secondary);">
    <div class="flex items-start justify-between mb-6">
      ...
      <div class="ml-4">
        <a href="{{ route('dashboard.clientes.create') }}" class="inline-flex items-center px-4 py-2 rounded-md text-white btn-green" style="background: var(--green);" data-nav>
    ...
    <div>
      @include('components.lists.listClient')
    </div>
  </main>
  @endif
@endsection
